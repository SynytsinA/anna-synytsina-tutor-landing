...
export const VideoCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative rounded-[36px] p-2 shadow-2xl border border-slate-200 cursor-pointer transition-all duration-500 aspect-[9/17] mx-auto group will-change-transform transform-gpu",
