...
const HeroQuiz = dynamic(
  () => import("@/components/features/HeroQuiz").then((m) => m.HeroQuiz),
  {
    ssr: false,
    loading: () => <HeroQuizSkeleton />,
  }
);
      ...
      <div className="max-w-[1200px] mx-auto px-5 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-20 items-center">
          <div className="flex flex-col items-start order-1">
            <FadeIn delay={config.fadeDelays.badge} immediate>
            ...
            <FadeIn delay={config.fadeDelays.title} immediate>
            ...
            <FadeIn delay={config.fadeDelays.subtitle} immediate>
          ...
          <div className="flex flex-col items-center justify-center relative order-2 mb-8 lg:mb-0 w-full">
            <FadeIn delay={config.fadeDelays.quiz} className="relative w-full flex justify-center" immediate>
              <Suspense fallback={<HeroQuizSkeleton />}>
                <HeroQuiz />
              </Suspense>
            </FadeIn>
          </div>
