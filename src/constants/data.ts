...
export const QUIZ_QUESTIONS: Record<"en" | "ua", Record<Subject, QuizQuestion[]>> = {
  ua: {
    ukrainian: [
      {
  ...
  en: {
    ...
    math: [
      ...
      {
        q: "What is a shape with 3 corners called?",
...
export const NAVIGATION_DATA = NAV_STRUCTURE;

export const GAMES_DATA = GAMES_SECTION_CONFIG;

export const SECTIONS_METADATA = {
  about: ABOUT_METADATA,
  approach: APPROACH_METADATA,
  footer: FOOTER_METADATA,
  videos: VIDEO_GALLERY_METADATA,
  services: SERVICES_CONFIG,
  classroom: GLOBAL_CLASSROOM_CONFIG,
  faq: FAQ_CONFIG,
  testimonials: {
...
export const QUIZ_DATA = QUIZ_QUESTIONS;
